...
import me.ninjoh.nincore.exceptions.NCIllegalArgumentDataTypeException;
import me.ninjoh.nincore.exceptions.NCPlayerNotFoundException;
...
public enum NCArgumentDataType implements IArgumentDataType
{
    BOOLEAN("boolean"),
    INTEGER("integer"),
    //FLOAT(),
...
//    BLOCK();
    ...
    NCArgumentDataType(String humanFriendlyName)
    {
    ...
    public void throwException(@NotNull CommandSender target, String actualValue)
    {
        try
        {
            switch(this.name())
            {
                ...
                case("BOOLEAN"):
                    throw new NCIllegalArgumentDataTypeException(target, "BOOLEAN", actualValue);
...
//                    return;
                ...
                case("PLAYER"):
                    throw new NCPlayerNotFoundException(target);
